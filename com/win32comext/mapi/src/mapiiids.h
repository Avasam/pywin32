// Shared USES_IID_* / USES_PS_* defines for MAPIGuid.h and MAPIAux.h.
// Included by both mapiguids.cpp (which defines GUIDs with INITGUID) and
// PyMAPIUtil.h (which declares them before MAPIGUID_H guard fires).
#pragma once
