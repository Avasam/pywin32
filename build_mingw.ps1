...
$TmpDir = '/tmp/msys2-python'
New-Item -ItemType Directory -Force $TmpDir | Out-Null
Invoke-WebRequest "${RepoUrl}${PkgName}" -OutFile "$TmpDir/python.pkg.tar.zst"
bash -c "cd $TmpDir && tar -x --zstd -f python.pkg.tar.zst mingw64/lib/libpython${PythonVer}.dll.a mingw64/include/python${PythonVer}/"

$WinPythonLib = "$TmpDir/mingw64/lib"
$WinPythonInclude = "$TmpDir/mingw64/include/python${PythonVer}"
